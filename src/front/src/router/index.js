...
export const asyncRouterMap = [
  ...
  //   component: Layout,
  //   redirect: '/application-manage/route-list',
  ...
  //   },
  //   children: [
  //     // { path: 'application-list', component: _import('application-manage/application-list'), name: 'application-list', meta: { title: 'applicationList', icon: 'table' }},
  //     { path: 'route-list', component: _import('application-manage/route-list'), name: 'route-list', meta: { title: 'routeList', icon: 'table' }},
  //     { path: 'route-index', component: _import('application-manage/route-index'), name: 'route-index', meta: { title: 'routeIndex', icon: 'table' }},
  //     // { path: 'route-list', hidden: true, component: _import('application-manage/jsonEditor'), name: 'route-list', meta: { title: 'routeList', icon: 'table' }},
  //     // { path: 'application-list1', component: _import('application-manage/application-list'), name: 'application-list1', meta: { title: 'applicationList', icon: 'table' }},
  //     { path: 'edit-form', hidden: true, component: _import('form/edit'), name: 'editForm1', meta: { title: 'editForm', icon: 'table' }}
  //   ]
  // },
